...
import { Lock, Mail, User as UserIcon, Phone, AlertCircle, Sparkles } from 'lucide-react';
    ...
    <div className="max-w-md mx-auto my-8 bg-white rounded-3xl border border-slate-200 p-6 md:p-8 shadow-sm animate-fade-in">
      <div className="text-center mb-6">
        ...
        <p className="text-xs text-slate-500 mt-1">
          Get personal AI news summaries and knowledge updates
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-xs font-semibold text-slate-700 mb-1">
            WhatsApp Number (Optional, e.g. +919876543210)
          </label>
          <div className="relative">
