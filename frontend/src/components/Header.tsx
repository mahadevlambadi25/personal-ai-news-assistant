    ...
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200/80 px-3 sm:px-6 py-2.5 transition-all">
      <div className="flex items-center justify-between gap-2 sm:gap-4 max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-sky-600 via-sky-500 to-indigo-600 text-white flex items-center justify-center shadow-md shadow-sky-500/15 group-hover:scale-105 transition-transform shrink-0">
              <Sparkles className="w-4.5 h-4.5" />
            </div>
            <div className="hidden sm:block">
              <span className="text-sm font-extrabold text-slate-900 tracking-tight block leading-tight">
                AI News <span className="text-sky-600 font-bold">&</span> Knowledge
              </span>
        ...
        >
          ...
          <input
            ...
            placeholder="Search news, topics, concepts..."
            aria-label="Search articles"
            className="w-full pl-9 pr-3 py-1.5 bg-slate-100/80 hover:bg-slate-100 border border-slate-200/90 rounded-xl text-xs sm:text-sm text-slate-800 placeholder-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 transition-all truncate"
          />
        </form>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
          ...
          <div
            className="flex items-center p-0.5 bg-slate-100 rounded-xl border border-slate-200/90 text-xs font-semibold"
            role="group"
          ...
          {canInstall && (
            <button
              ...
              className="hidden sm:inline-flex px-2.5 py-1.5 bg-sky-600 hover:bg-sky-700 text-white rounded-xl text-xs font-semibold items-center gap-1.5 shadow-sm transition-colors"
            >
